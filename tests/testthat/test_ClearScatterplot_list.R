...
test_that("list‐of‐matrices constructor single vs multi", {
  ...
  cs1 <- ClearScatterplot(data = list(one = mat1), meta = list(one = meta1))
  expect_s4_class(cs1, "ClearScatterplot")
  # multi
  ...
  cs2 <- ClearScatterplot(
    data = list(M1 = mat1, M2 = mat2),
    meta = list(M1 = meta1, M2 = meta2)
  )
  expect_s4_class(cs2, "ClearScatterplot")
